...
.pager_container .page_no:not(.pager_next_disabled):not(.pager_prev_disabled):hover,
.pager_container span:not(.pager_next_disabled):not(.pager_prev_disabled):hover {
...
.pager_container .pager_prev_disabled,
.pager_container .pager_next_disabled,
...
.ui-menu .ui-menu-item a.ui-state-focus i,
...
.ui-widget textarea,
.ui-widget button {
  font-family: "Microsoft Yahei", Trebuchet MS, Tahoma, Verdana, Arial, sans-serif;
  font-size: 1em
}
...
.ui-state-default a:link i,
.ui-state-default a:visited i {
  color: #fff
}
...
.ui-state-hover a i,
.ui-state-hover a:hover i,
.ui-state-hover a:link i,
...
.company-card .item_con_list:before,
...
.company-card .cl_r .cl_r_bot .list_c:before,
...
ul.filter-wrapper li a.active,
ul.filter-wrapper li a:hover {
  background-color: #00b38a;
  color: #fff
}
...
ul.filter-wrapper li .btn-more i,
ul.filter-wrapper li .btn-more-hy i {
  position: absolute;
  top: 15px;
  right: -3px;
  font-size: 0;
...
ul.filter-wrapper li .btn-more:hover,
ul.filter-wrapper li .btn-more-hy:hover {
  background-color: transparent;
  color: #555
}

ul.filter-wrapper li .btn-more:hover i,
ul.filter-wrapper li .btn-more-hy:hover i {
  -webkit-transform: rotate(180deg);
  -moz-transform: rotate(180deg);
  -ms-transform: rotate(180deg);
  transform: rotate(180deg);
...
ul.filter-wrapper .has-more .more,
ul.filter-wrapper .has-more .more-hy {
  display: none;
  position: absolute;
  z-index: 10;
  top: 0;
...
ul.filter-wrapper .has-more .more.unfolded,
ul.filter-wrapper .has-more .more-hy.unfolded {
  display: block
}

ul.filter-wrapper .has-more .more .other,
ul.filter-wrapper .has-more .more-hy .other {
...
ul.filter-wrapper .has-more .choose-detail .detail-district-area,
ul.filter-wrapper .has-more .choose-detail .detail-bizArea-area {
  background-color: #fff;
  padding-left: 33px;
...
ul.filter-wrapper .has-more .choose-detail .detail-district-area a,
ul.filter-wrapper .has-more .choose-detail .detail-bizArea-area a {
  margin-top: 3px;
  margin-bottom: 2px
}
...
ul.filter-wrapper .has-more .choose-detail .current_district,
ul.filter-wrapper .has-more .choose-detail .current_bizArea {
  margin-left: 25px;
  color: #00b38a
}
...
ul.order .wrapper .item.order a,
ul.order .wrapper .item.order span {
  float: left;
  margin-right: 5px;
  padding: 5px 8px;
  height: 14px;
...
ul.order .wrapper .item.order a.active,
ul.order .wrapper .item.order a:hover {
  background-color: #00b38a;
  color: #fff
}
...
ul.order .wrapper .item.page .prev::selection,
ul.order .wrapper .item.page .next::selection {
  background-color: transparent
}
...
.no_position_wrapper .no_position:before,
...
.s_position_list .list_item_top .position .p_top h2 {
  float: left;
  max-width: 270px;
  margin: 0;
  font-size: 16px;
...
.s_position_list .list_item_top .position .p_top h2 a,
.s_position_list .list_item_top .position .p_top h2 span {
  font-size: 16px;
  color: #00b38a
}
...
.s_position_list .list_item_top .position .p_top .pos_icon_small {
  float: left;
  width: 59px;
  height: 22px;
  margin-left: .5em;
...
.company_list .item_con_list:before,
...
.company_list .c_list_item:before,
...
.company_list .cl_r .cl_r_bot .list_c:before,
...
.company_list .empty_position:before,
...
.recommend-comp-city .r_search_tit,
.recommend-comp-city .r_company_tit,
...
.recommend-comp-city .r_company_con,
.recommend-comp-city .r_city_con {
  margin-top: 10px;
  zoom: 1
}

.recommend-comp-city .r_company_con:before,
.recommend-comp-city .r_city_con:before,
.recommend-comp-city .r_company_con:after,
.recommend-comp-city .r_city_con:after {
  content: "";
  display: table
}
